...
const Hero = ({}: HeroProps): React.JSX.Element => {
  return (
    <div className="container mx-auto flex flex-col items-center justify-center h-screen py-4 px-4 max-w-4xl xl:p-0">
      ...
      <a href="/play" className="mt-6 px-6 py-2 bg-primary-500 text-black rounded-md hover:bg-primary-600 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-opacity-50 font-bold">
